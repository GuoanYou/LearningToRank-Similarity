...
#求解覆盖率
	...
	save("WekaSimilarity.txt",c5)
	save("WekaSimilarity.txt",c10)
	save("WekaSimilarity.txt",c15)

	save("WekaSimilarity.txt",fgx)
	#保存Kendall
	...
	save("WekaSimilarity.txt",tau5)
	save("WekaSimilarity.txt",tau10)
	save("WekaSimilarity.txt",tau15)
	...
	save("WekaSimilarity.txt",p5)
	save("WekaSimilarity.txt",p10)
	save("WekaSimilarity.txt",p15)
	...
	save("WekaSimilarity.txt",s5)
	save("WekaSimilarity.txt",s10)
	save("WekaSimilarity.txt",s15)

#读取数据
if os.path.exists("WekaSimilarity.txt")==1:
		os.remove("WekaSimilarity.txt")
for i in range(0,5):
	list1= get_data("savetest_y_%d.txt"%i)
	list2= get_data("savetest_hy_%d.txt"%i)
	savefgx("WekaSimilarity.txt")
	dabao(list1,list2)